...
<div class="sikfSectionTitre"><bean:message key="step1.title" /></div>
    ...
    <table size="100%">
                ...
                <tr>
                    ...
                    <input type="button" class="sikfBoutonAction" value="<bean:message key="button.confirm" />" onclick="window.location='step2.jsp';" />&nbsp;<input type="button" class="sikfBoutonAction" value="<bean:message key="button.cancel" />"  />
                    </td>
                </tr>
    </table>
    </fieldset>
